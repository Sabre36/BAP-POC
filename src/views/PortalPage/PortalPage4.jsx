    ...
    handleViewClick = async (index) => {
        ...
        render() {
            ...
            return (
                    ...
                    <AppBar position='sticky' style={{backgroundColor: '#1463AC', position: 'fixed', top: '110px'}}>
                        ...
                        <section style={styles.rightToolbar}>
                            <IconButton color='inherit' aria-label='Filters'>
                                <FilterIcon onClick={() => this.onSetSidebarOpen(true)}/>
                            </IconButton>
                ...
                <div style={{ margin: '55px', color: '#000'}}>
                    <Sidebar
                        open={this.state.sidebarOpen}
                        onSetOpen={this.onSetSidebarOpen}
                        sidebar={<div style={{margin: '15px'}}>
                            ...
                            <ExpansionPanel style={{backgroundColor: 'transparent', color: '#fff'}}>
                              ...
                              <Divider/>
                                ...
                                <Button variant="raised" color="secondary" style={{marginLeft: '10px'}}>
                                    SAVE FILTERS
                                </Button>
                        ...
                        docked={false}
                        pullRight={true}
                        styles={{ sidebar: { background: "rgba(0,0,0,.9)", color: 'white', width: '300px', position: 'absolute', top: '175px'} }}
                      >
                    </Sidebar>
